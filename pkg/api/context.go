...
func GetContextValues(ctx context.Context) (*ContextValues, error) {
	...
	if !ok {
		log.Print("api value missing from GetContextValues")
...
func SetTracerUID(ctx context.Context, traceid string) error {
	v, ok := ctx.Value(key).(*ContextValues)
	if !ok {
		log.Print("api value missing from SerTracerUID")
...
func SetStatusCode(ctx context.Context, statusCode int) error {
	v, ok := ctx.Value(key).(*ContextValues)
	if !ok {
		log.Print("api value missing from SetStatusCode")
		return errors.New("api value missing from context")
	}
...
func SetIsError(ctx context.Context) error {
	v, ok := ctx.Value(key).(*ContextValues)
	if !ok {
		log.Print("api value missing from SetIsError")
		return errors.New("api value missing from context")
	}
	v.IsError = true
	return nil
...
func SetIsPanic(ctx context.Context) error {
	v, ok := ctx.Value(key).(*ContextValues)
	if !ok {
		log.Print("api value missing from SetIsPanic")
		return errors.New("api value missing from context")
	}
	v.IsPanic = true
	return nil
...
func SetPath(ctx context.Context, path string) error {
	v, ok := ctx.Value(key).(*ContextValues)
	if !ok {
		log.Print("api value missing from SetPath")
		return errors.New("api value missing from context")
	}
	v.Path = path
	return nil
